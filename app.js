...
var map = new mapboxgl.Map({
  ...
  // my custom Colorado Breweries style: style: 'mapbox://styles/jakecoolidge/civlltrcb009q2jp5njlzz4f2',
...
map.on('load', function(e) {
  ...
  console.log(buildLocationList(stores));
});
...
function buildLocationList(data) {
  ...
  for (i = 0; i < data.features.length; i++) {
    ...
    link.dataPosition = i;
    link.innerHMTL = prop.address;
    // create a new div with the class 'details' for each store and fill it with the city and the phone number
    var details = listing.appendChild(document.createElement('div'));
    details.innerHMTL = prop.city;
    if (prop.phone) {
      details.innerHMTL += ' &middot; ' + prop.phoneFormatted;
    }
  }
}
